...
function Signup() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex min-h-screen items-center justify-center p-3 sm:p-4 md:p-6 bg-slate-50", children: /* @__PURE__ */ jsxs(Card, { className: "w-full max-w-md p-5 sm:p-6 md:p-8 shadow-xl border border-slate-200 bg-white", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-6 sm:mb-8 text-center", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl sm:text-3xl font-bold text-slate-900", children: "Create Account" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1.5 sm:mt-2 text-sm sm:text-base text-slate-600 font-medium", children: "Get started with your free account" })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "name", className: "block text-sm font-semibold mb-2 text-slate-700", children: "Name" }),
        /* @__PURE__ */ jsx(Input, { id: "name", name: "name", type: "text", placeholder: "John Doe", required: true, className: "border-slate-300 focus:border-teal-500 focus:ring-teal-500" })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "password", className: "block text-sm font-semibold mb-2 text-slate-700", children: "Password" }),
        /* @__PURE__ */ jsx(Input, { id: "password", name: "password", type: "password", placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", required: true, minLength: 8, className: "border-slate-300 focus:border-teal-500 focus:ring-teal-500" })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "passwordConfirm", className: "block text-sm font-semibold mb-2 text-slate-700", children: "Confirm Password" }),
        /* @__PURE__ */ jsx(Input, { id: "passwordConfirm", name: "passwordConfirm", type: "password", placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", required: true, minLength: 8, className: "border-slate-300 focus:border-teal-500 focus:ring-teal-500" })
      ] }),
      error && /* @__PURE__ */ jsx("div", { className: "bg-red-50 border border-red-200 rounded-lg p-3", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600 font-medium", children: error }) }),
      /* @__PURE__ */ jsx(Button, { type: "submit", className: "w-full bg-teal-500 hover:bg-teal-600 shadow-lg hover:shadow-xl transition-all hover:scale-105 text-white font-semibold", children: "Sign Up" })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxs(Button, { type: "button", variant: "outline", className: "w-full border border-slate-300 hover:bg-slate-50 hover:border-slate-400 transition-all", onClick: handleGoogleSignup, children: [
      ...
      /* @__PURE__ */ jsxs(Button, { type: "button", variant: "outline", className: "w-full border border-slate-300 hover:bg-slate-50 hover:border-slate-400 transition-all", onClick: handleGithubSignup, children: [
...
//# sourceMappingURL=signup-CQEB33n9.mjs.map
